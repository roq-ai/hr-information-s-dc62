...
-- AddForeignKey
ALTER TABLE "job_application" ADD CONSTRAINT "job_application_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
